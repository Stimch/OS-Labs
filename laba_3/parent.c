...
int main() {
    ...
    // Ввод названия файла для вывода результата
    printf("Введите название файла для вывода результата: ");
    ...
    if (child_pid == -1) {
        ...
        const char* args[] = {"./child", output_filename, filesize_str, output_filename, NULL};
